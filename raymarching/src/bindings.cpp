...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("composite_rays_train_forward_sdf", &composite_rays_train_forward_sdf, "composite_rays_train_forward_sdf (CUDA)");
    m.def("composite_rays_train_backward_sdf", &composite_rays_train_backward_sdf, "composite_rays_train_backward_sdf (CUDA)");
    // infer
